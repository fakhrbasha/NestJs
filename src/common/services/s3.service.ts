...
// import { AWS_ACCESS_KEY, process.env.AWS_BUCKET_NAME, AWS_REGION, AWS_SECRUT_ACCESS_KEY } from "../../config/config.service";
    ...
    constructor() {
        this.client = new S3Client({
            ...
            credentials: {
                ...
                secretAccessKey: process.env.AWS_SECRUT_ACCESS_KEY!
            }
        })
